...
@section('account-content')
    ...
    @if(isEmployee() && !isBoard())
        <div class="alert alert-info mb-4">
            Only administrators can update your profile information. You may only change your password.
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Nome -->
            <div>
                <label class="block text-sm font-medium form-input-label">Name</label>
                <input type="text" value="{{ auth()->user()->name }}" class="mt-1 block w-full rounded-md border-2 border-gray-300 bg-gray-100 form-input-field py-2 px-4" disabled />
            </div>
            <!-- Email -->
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <!-- Género -->
            <div>
                <label class="block text-sm font-medium form-input-label">Gender</label>
                <input type="text" value="{{ auth()->user()->gender == 'M' ? 'Male' : 'Female' }}" class="mt-1 block w-full rounded-md border-2 border-gray-300 bg-gray-100 form-input-field py-2 px-4" disabled />
            </div>
            <!-- Foto -->
            <div>
