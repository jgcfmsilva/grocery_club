        ...
        <form method="POST" action="{{ route('my-account.change-password.update') }}">
            ...
            <div class="mb-3">
                ...
                <div style="position: relative;">
                    <input type="password" name="current_password" id="current_password" class="form-control pr-10" required autocomplete="current-password" style="padding-right: 2.5rem;" value="{{ old('current_password') }}">
            ...
            <div class="mb-3">
                ...
                <div style="position: relative;">
                    <input type="password" name="password" id="password" class="form-control pr-10" required autocomplete="new-password" style="padding-right: 2.5rem;" value="{{ old('password') }}">
            ...
            <div class="mb-10">
                ...
                <div style="position: relative;">
                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control pr-10" required autocomplete="new-password" style="padding-right: 2.5rem;" value="{{ old('password_confirmation') }}">
...
@push('scripts')
    @vite('resources/js/pages/my-account/change-password.js')
@endpush
