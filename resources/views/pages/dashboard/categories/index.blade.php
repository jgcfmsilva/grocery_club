...
<div class="container mx-auto">
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
        <h1 class="text-3xl font-bold mb-0">Categories</h1>
        <a href="{{ route('dashboard.categories.create') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-xl shadow-md font-semibold text-md text-center w-full md:w-auto">
