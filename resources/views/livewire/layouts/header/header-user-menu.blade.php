...
=======
                @if (auth()->user()->type === \App\Enums\UserType::PendingMember || auth()->user()->type === \App\Enums\UserType::Member || auth()->user()->type === \App\Enums\UserType::Employee)
>>>>>>> Stashed changes
            ...
            @guest
                <li><a href="{{ route('login') }}" class="text-dark"><span class="me-2"><i
                                class="fa-solid fa-arrow-right-from-bracket"></i></span>Log In</a></li>
                <li><a href="{{ route('register') }}" class="text-dark"><span class="me-2"><i
                                class="fa-solid fa-user-plus"></i></span>Registration</a></li>
            @endguest
        </ul>
    </div>
</div>
